...
abstract class $LoginListenableCopyWith<$Res> {
  ...
  @useResult
  $Res call({LoginEffect effect, String? errorText});
}
...
class _$LoginListenableImpl implements _LoginListenable {
  const _$LoginListenableImpl({required this.effect, this.errorText});
  ...
  @override
  String toString() {
    return 'LoginListenable(effect: $effect, errorText: $errorText)';
  }
...
abstract class _LoginListenable implements LoginListenable {
  const factory _LoginListenable(
      ...
      final String? errorText}) = _$LoginListenableImpl;
